...
btnSub = Button(calc, text="-", width=6, height=2, font=('arial', 20, 'bold'), bd=4,
                bg="powder blue",command = lambda : added_value.operation("sub")
                ).grid(row=2, column=3, pady=1)

btnMult = Button(calc, text="*", width=6, height=2, font=('arial', 20, 'bold'), bd=4,
                 bg="powder blue", command = lambda : added_value.operation("multi")
...
btnMod = Button(calc, text="Mod", width=6, height=2, font=('arial', 20, 'bold'), bd=4,
                bg="powder blue", command = lambda: added_value.Mod).grid(row=3, column=6, pady=1)
...
btn1gamma = Button(calc, text="1gamma", width=6, height=2, font=('arial', 20, 'bold'), bd=4,
                   bg="powder blue", command = added_value.gamma).grid(row=5, column=7, pady=1)
